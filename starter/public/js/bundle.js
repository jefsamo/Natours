...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1Ijoic2hvcGV5aW41IiwiYSI6ImNrOXdwdm5mNjAzZTEzZXFkM2szemU3YTcifQ.GD9WA5qm6icYVZoF2SWFvg';
  var map = new mapboxgl.Map({
    container: 'map',
    style: 'mapbox://styles/shopeyin5/ck9wqegk00ncc1ipgz6t16px1',
    scrollZooom: false //   center: [-118.113491, 34.111745],
    //   zoom: 4,
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 4:
            ...
            if (res.data.status === 'success') {
              (0, _alert.showAlert)('success', "".concat(type.toUpperCase(), " Updated Successfully reload for picture update"));
            }
...
var stripe = Stripe('pk_test_UQwdMECFoXOfelcgCuZsnymX00OOGcBg1S');
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            e.preventDefault();
            document.querySelector('.btn--save-updates').textContent = 'Updating..';
            form = new FormData();
          ...
          case 9:
            document.querySelector('.btn--save-updates').textContent = 'SAVE SETTINGS';
